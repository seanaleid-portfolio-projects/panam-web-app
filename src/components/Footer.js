  ...
  return (
    <Container>
      <Top>
        ...
        <SmallText>
          Stay up to date! Receive our news and promotions in your inbox.
        </SmallText>
        <Form action="https://formspree.io/xyynrlap" method="POST">
      ...
      <Bottom>
        ...
        <Box>
          <IconBox>
            <Circle>
              <a
                href="https://www.google.com/maps/place/3051+Nutley+St,+Fairfax,+VA+22031/@38.8707361,-77.263134,17z/data=!3m1!4b1!4m5!3m4!1s0x89b64b8a8b8d7f89:0xc7c7246eebcb198f!8m2!3d38.8707361!4d-77.2609453"
                target="_blank"
            ...
            <Circle>
              <a href="tel:+1-703-560-9322" title="Give us a call!">
                <Phone />
              </a>
            </Circle>
            <Circle>
              <a href="mailto:panamfamrest@gmail.com" title="Send us an email">
                <Envelope />
              </a>
            </Circle>
            <Circle>
              <a
                href="https://www.facebook.com/Pan-AM-Family-Restaurant-Inc-111595428879650/"
          ...
          <SmallColorText>
            ...
            <Tag
              ...
              title="Visit Font Awesome's website"
            >
              Font Awesome
            </Tag>{" "}
            and{" "}
            <Tag
              ...
              title="Visit Font Awesome's license page"
            >
              license used.
            </Tag>
          </SmallColorText>
