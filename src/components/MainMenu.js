...
const MainMenu = () => {
  return (
    <>
      <SEO
        title="PanAm Family Restaurant - Main Menus"
        description="Order a souvlaki. Try our Pizza. We've got something on the menu for everyone!"
        profileURL={"https://www.panamfamrest.com/main-menu"}
      />
      <Container>
        <MenuContainer>
        ...
        <SectionBox>
          ...
          <BoxBottom>
            ...
            <BottomTextDescription>
              chopped romaine lettuce, croutons, parmesean cheese, ceasar
              dressing
            </BottomTextDescription>
            <BottomTextDescription>
            ...
            <BottomTextDescription>
              ham, turkey, and provolone, over lettuce, tomato, cucumber,
              onions, and choice of dressing
            </BottomTextDescription>
        ...
        <SectionBox>
          ...
          <BoxBottom>
            ...
            <BottomTextDescription>
              zucchini, yellow sqaush, carrots, red onion, spinach, with
              spaghetti with kourtaki wine and marinara sauce
            </BottomTextDescription>

            <BottomTextItem>pan am stuffed cabbage</BottomTextItem>
            <BottomTextDescription>
              ground beef and rice stuffed in cabbage, topped with marinara
            ...
            <BottomTextDescription>
              choice of beef or chicken, with peppers, onions, tomatoes, on top
              of white rice
            </BottomTextDescription>
        ...
        <SectionBox>
          ...
          <BoxBottom>
            ...
            <BottomTextDescription>
              choice of protein, served with romaine lettuce, marinated
              tomatoes, rice, feta, avocado, tzatiki, and pita
            </BottomTextDescription>

            <BottomTextItem>*chicken, pork, or gyro platter</BottomTextItem>
            <BottomTextDescription>
              choice of protein, served with a side greek salad, french fries,
              and pita
            </BottomTextDescription>
        ...
        <SectionBox>
          ...
          <BoxBottom>
            ...
            <BottomTextDescription>
              ...
              parmesan served on a toasted sub topped with provolone and
              marinara, served with chips
            </BottomTextDescription>
            ...
            <BottomTextDescription>
              turkey, provolone, lettuce, tomato and mayonnaise, served with
              chips
            </BottomTextDescription>
          </BoxBottom>
        </SectionBox>
        ...
        <SectionBox>
          ...
          <BoxBottom>
            ...
            <BottomTextDescription>
              bacon, turkey, cheese, lettuce, tomato, and mayonnaise, served
              with french fries
            </BottomTextDescription>
            ...
            <BottomTextDescription>
              corned beef, sauerkraut, and Swiss cheese on rye, served with
              french fries
            </BottomTextDescription>

            <BottomTextItem>corned beef or pastrami sandwich</BottomTextItem>
            <BottomTextDescription>
              choice of corned beef and pastrami topped with Swiss cheese on
              rye, served with french fries
            </BottomTextDescription>
          </BoxBottom>
        </SectionBox>
        ...
        <SectionBox>
          ...
          <BoxBottom>
            ...
            <BottomTextDescription>
              pasta sleeves stuffed with ricotta cheese, topped and baked with
              marinara and mozzarella cheese
            </BottomTextDescription>

            <BottomTextItem>chicken piccata</BottomTextItem>
            <BottomTextDescription>
              sautéed chicken breast with lemon sauce, mushrooms, and capers,
              served over pasta
            </BottomTextDescription>
          </BoxBottom>
        </SectionBox>
        ...
        <SectionBox>
          ...
          <BoxBottom>
            ...
            <BottomTextDescription>
              pepperoni, sausage, ground beef, bacon, meatball, ham, salami,
              gyro meat, anchovies
            </BottomTextDescription>
